...
#define FILETREE_ICON_MARKDOWN		ICON_FA_FILE_CODE
...
#define SOURSEPAGE_FOLDER_POPUP_SUBADD_NEW_Markdown		Moui::IconAndChinese(ICON_FA_FILE_POWERPOINT, u8"新建Markdown").c_str()
